...
class QuadrotorEnv(gym.Env):
    ...
    def __init__(self):
        ...
        # Disturbance estimator parameters L1 bound (no need to change)
        self.max_v = 10.0
        self.a = 1.0
        self.lt = 1.0
        ...
        self.x_ref_traj, self.z_ref_traj, self.dx_ref_traj, self.dz_ref_traj, self.ddx_ref_traj, self.ddz_ref_traj,  self.x_bound, self.z_bound = self.generate_trajectory()
        ...
        self.x_ref_traj, self.z_ref_traj, self.dx_ref_traj, self.dz_ref_traj, self.theta_ref_traj, self.dtheta_ref_traj = self.generate_trajectory_PD()

    # Generate ideal trajectory
    def generate_trajectory(self, scale_factor=0.5, shape='circle'): 
    ...
    # Generate state trajectory using PD controller
    def generate_trajectory_PD(self):
        x_ref_traj = []
        z_ref_traj = []
        dx_ref_traj = []
        dz_ref_traj = []
    ...
    # Define the observation as [real_state, ref_state] 12x1
