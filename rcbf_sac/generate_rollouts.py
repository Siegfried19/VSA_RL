...
def generate_model_rollouts(env, memory_model, memory, agent, dynamics_model, k_horizon=1, batch_size=20, warmup=False):
    ...
    # L1_estimator = L1E_batch(dynamics_model.get_state(obs_batch_), env)
    ...
    for k in range(k_horizon):
        ...
        # next_state_batch_, next_t_batch_ = L1_estimator.predict_next_state(state_batch_, action_batch_, t_batch=t_batch)
